...
here()
p1 <- read_csv(here("data", "survey_data_download_v3", "DAC_P1_v3.csv"))
p2 <- read_csv(here("data", "survey_data_download_v3", "DAC_P2_v3.csv"))
p3 <- read_csv(here("data", "survey_data_download_v3", "DAC_P3_v3.csv"))
p4 <- read_csv(here("data", "survey_data_download_v3", "DAC_P4_v3.csv"))
p5 <- read_csv(here("data", "survey_data_download_v3", "DAC_P5_v3.csv"))
