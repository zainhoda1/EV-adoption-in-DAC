...
```{r}
sd_next(next_page = 'Preliminary_elimination')
```
:::

::: {#Preliminary_elimination .sd-page}

## Please answer some preliminary questions before we begin the survey!
